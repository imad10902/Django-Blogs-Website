...
class Blog(models.Model):
    ...
    draft = models.CharField(
        max_length=4, choices=DRAFT, default="NO"
    )
    summary = models.TextField(null=True, blank=False)
    content = models.TextField(null=True, blank=False)
    updated = models.DateTimeField(auto_now=True, null=True) #whenever user updates something about this model, date is recorded
    created = models.DateTimeField(auto_now_add=True, null=True) # records date of creation og entry of this model table
